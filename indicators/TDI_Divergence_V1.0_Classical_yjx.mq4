//+------------------------------------------------------------------+
//|                                          TDI_Divergence_V1.0_Classical_yjx.mq4 |
//|                                                              FX5 |
//|                                                    hazem@uk2.net |
//+------------------------------------------------------------------+
...
//----
   ...
   IndicatorShortName("TDI_Divergence_v1.0_Classical_yjx()");
   return(0);
  }
//+------------------------------------------------------------------+
...
void CatchBullishDivergence(int shift)
  {
   ...
   //add by yjx
   if(lastTrough - currentTrough <=2 || lastTrough - currentTrough >= 80)
      return;
//----
...
void CatchBearishDivergence(int shift)
  {
   ...
   //add by yjx
   if(lastPeak - currentPeak <=2 || lastPeak - currentPeak >= 80)
      return; 
//----
...
void DrawIndicatorTrendLine(datetime x1, datetime x2, double y1, 
                            double y2, color lineColor, double style)
  {
   int indicatorWindow = WindowFind("TDI_Divergence_v1.0()");
//----
